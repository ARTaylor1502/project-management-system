<template>
    <modal @close-modal="closeModal">
        <template slot="header">Add New User Address</template>
        <template slot="body">
            <form @submit.prevent="addUserAddressHandler">
    ...
    export default {
        ...
        methods: {
            addUserAddressHandler() {
                if(this.user_id) {
                    this.addUserAddress(this.user_id, this.address);
                } else {
                    this.$eventHub.$emit('proposed-user-address-added', this.address);
                }
            },
            ...
            closeModal() {
                this.$emit('add-user-address-modal-closed');
            }
        }
    }
